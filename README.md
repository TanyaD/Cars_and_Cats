...
Cars and Cats
Node server. Create a folder called cars_and_cats, this will be your root folder for this project.  Within this folder, create:
...
Server must be capable of handling the following URL requests:
